# Edunexy - Online Education Platform (MERN App) [Website Link](https://edunexy-frontend.vercel.app/)

![Main Page](https://github.com/moni9083/EDUNEXY-An-Online-Education-Platform/assets/86844595/72f26ff1-8739-43cc-a854-3d074cb3b130)

## Project Description

Edunexy is a fully functional ed-tech platform that enables users to create, consume,
and rate educational content. The platform is built using the MERN stack, which includes
ReactJS, NodeJS, MongoDB, and ExpressJS.
Edunexy aims to provide:
...
In summary, Edunexy is a versatile and intuitive ed-tech platform that is designed to
...
The Edunexy ed-tech platform consists of three main components: the front end, the
...
Here is a high-level diagram that illustrates the architecture of the Edunexy ed-tech
platform:

![architecture](https://github.com/moni9083/EDUNEXY-An-Online-Education-Platform/assets/86844595/e28bcfb1-e96f-4430-9fbc-e90f44ee867a)


## Front End

The front end of Edunexy has all the necessary pages that an ed-tech platform should
...
Edunexy uses a monolithic architecture, with the backend built using Node.js and
Express.js, and MongoDB as the primary database. 

Features and Functionalities of the Back-end: 
The back end of Edunexy provides a range of features and functionalities, including:
...
1. Cloud-based media management: Edunexy uses Cloudinary, a cloud-based media
...
The back end of Edunexy uses a range of frameworks, libraries, and tools to ensure its
...
The back end of Edunexy uses a range of data models and database schemas to
...
Overall, the back-end of Edunexy is designed to provide a robust and scalable solution
...
![schema](https://github.com/moni9083/EDUNEXY-An-Online-Education-Platform/assets/86844595/88060bb0-c3cd-42f5-97d5-cabeddfb580f)

## API Design

The Edunexy platform's API is designed following the REST architectural style. The
...
In conclusion, the REST API design for the Edunexy ed-tech platform is a crucial part
...
what kind of data it will accept or return. With this API design, Edunexy will be able to
